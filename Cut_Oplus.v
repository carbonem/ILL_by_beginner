  ...
  * inversion HeqcutF.
...

    {
      ...
      - clear IHA1. clear IHA2.
        ...
        destruct HeqCF as [[t1 [t2 t3]] | [l t]].
        * discriminate.
        * subst.
          assert (eq: 
                    (One :: l) ++ [A # B] ++ Delta2 =
          ...
          apply (OplusR1 n Gamma A B) in LH.
          ...
          apply (OneL z (Gamma ++ l ++ Delta2) A0)
            in IHl.
      ...
      - subst. 
        ...
        apply element_in_app_head in HeqCF.
        {
          ...
          - destruct L as [t1 [t2 t3]].
            inversion t2.
            subst. clear backup. clear t2.
            clear IHl.

            assert(RH1': n0;
                   [] ++ [A] ++ Delta2 |- C)
              by auto.
            apply (IHA1 n n0 C Gamma
                        [] Delta2 LH) in RH1'.
            destruct RH1' as [z1 H1].
            exists z1; auto.
...

    {
      ...
      - clear IHA1. clear IHA2.
        ...
        * subst.
          ...
          apply (OplusR2 n Gamma A B) in LH.
          assert (eq1 : S n + n0 < S n + S n0)
            by omega.
          assert (eq2 : S n + n0 = S n + n0)
            by omega.
      ...
      - apply app_singleton in HeqCF.
        ...
        exists (S n).
        rewrite app_nil_r.
        apply (OplusR2 n Gamma A B); auto.
        ...
        apply element_in_app_head in HeqCF.
        {
          ...
          - destruct L as [t1 [t2 t3]].
            ...
            assert(RH2': n0;
                   [] ++ [B] ++ Delta2 |- C)
              by auto.
            apply (IHA2 n n0 C Gamma
                        [] Delta2 LH) in RH2'.
            destruct RH2' as [z1 H1].
            exists z1; auto.
